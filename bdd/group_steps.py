...
def non_emptry_group_list(db, app):
...
def random_group(non_emptry_group_list):
    return random.choice(non_emptry_group_list)
...
def verify_group_deleted(db, non_emptry_group_list, random_group, app, check_ui):
    old_groups = non_emptry_group_list
    new_groups = db.get_group_list()
